...
<section class="bg-gray-700">
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="flex flex-wrap justify-center">
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-amber-400 bg-gray-900 dark:hover:border-transparent mb-8 mr-4">
                ...
                <a class="inline-block rounded border border-current px-8 py-3 text-sm font-medium text-amber-400 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-amber-400" href="{{ route('exercices.show', $exercice->id) }}">
                        Read More
                    </a>
            </div>
            @endforeach
